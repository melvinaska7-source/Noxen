...
import ru.noxen.common.util.other.BufferUtil;
...
import ru.noxen.implement.features.modules.combat.NoInteract;
...
public abstract class MinecraftClientMixin implements QuickImports {
    ...
    private void onWindowTitle(CallbackInfoReturnable<String> cir) {
        cir.setReturnValue("NOXEN VISUALS - " + SharedConstants.getGameVersion().getName());
    }
