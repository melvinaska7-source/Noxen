package ru.noxen.api.system.font;
...
import ru.noxen.api.system.font.entry.DrawEntry;
import ru.noxen.api.system.font.glyph.Glyph;
import ru.noxen.api.system.font.glyph.GlyphMap;
...
public class FontRenderer implements QuickImports {
    ...
    public static @NotNull Identifier randomIdentifier() {
        return Identifier.of("noxen", "temp/" + StringUtil.randomString(32));
    }
