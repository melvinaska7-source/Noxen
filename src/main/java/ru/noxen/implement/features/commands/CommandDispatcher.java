...
import ru.noxen.api.feature.command.exception.CommandNotFoundException;
...
import ru.noxen.implement.events.chat.ChatEvent;
import ru.noxen.implement.events.chat.TabCompleteEvent;
import ru.noxen.common.QuickLogger;
import ru.noxen.implement.features.commands.argument.ArgConsumer;
import ru.noxen.implement.features.commands.argument.CommandArguments;
import ru.noxen.implement.features.commands.manager.CommandRepository;
import java.util.List;
import java.util.stream.Stream;

import static ru.noxen.api.feature.command.IBaritoneChatControl.FORCE_COMMAND_PREFIX;
