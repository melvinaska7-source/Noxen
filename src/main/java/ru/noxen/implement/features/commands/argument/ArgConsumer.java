...
package ru.noxen.implement.features.commands.argument;

import ru.noxen.api.feature.command.argument.IArgConsumer;
import ru.noxen.api.feature.command.argument.ICommandArgument;
import ru.noxen.api.feature.command.datatypes.IDatatype;
import ru.noxen.api.feature.command.datatypes.IDatatypeContext;
import ru.noxen.api.feature.command.datatypes.IDatatypeFor;
import ru.noxen.api.feature.command.datatypes.IDatatypePost;
import ru.noxen.api.feature.command.exception.CommandException;
import ru.noxen.api.feature.command.exception.CommandInvalidTypeException;
import ru.noxen.api.feature.command.exception.CommandNotEnoughArgumentsException;
import ru.noxen.api.feature.command.exception.CommandTooManyArgumentsException;
import ru.noxen.api.feature.command.manager.ICommandManager;
