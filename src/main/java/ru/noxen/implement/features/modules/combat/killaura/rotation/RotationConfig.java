package ru.noxen.implement.features.modules.combat.killaura.rotation;

import lombok.AccessLevel;
import lombok.experimental.FieldDefaults;
import net.minecraft.entity.Entity;
import net.minecraft.util.math.Vec3d;
import ru.noxen.implement.features.modules.combat.killaura.rotation.angle.AngleSmoothMode;
import ru.noxen.implement.features.modules.combat.killaura.rotation.angle.LinearSmoothMode;
