package ru.noxen.implement.screens.menu;
...
import ru.noxen.implement.screens.menu.components.implement.other.*;
import ru.noxen.implement.screens.menu.components.implement.settings.TextComponent;

import java.util.ArrayList;
import java.util.Arrays;
import java.util.List;

import static ru.noxen.api.system.animation.Direction.BACKWARDS;
import static ru.noxen.api.system.animation.Direction.FORWARDS;
